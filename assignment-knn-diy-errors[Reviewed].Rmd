...
prop <- round(prop.table(cnt)*100, digits = 1)
...
Error 1: Error in line 39. Function strw not found, has to be str()
Error 2: Wrong index in line 70, should be -2 to delete the data column
Error 3: Wrong function used in line 77, should be relevel()
Error 4: Error in line 89, 0 used instead of O for variable
Error 5: Error in line 104, variable cleanDF_n doesn't exist. Must be cleand2
Error 6: Error in line 110 to 118, no use of brackets en wrong object used in line 112. In line 115 x is missing in the index.
Error 7: Line 126,127,129,130 errors because use of ; instead of :
